...
jongsung = ['ㄱ', 'ㄲ', 'ㄳ', 'ㄴ', 'ㄵ', 'ㄶ', 'ㄷ', 'ㄹ', 'ㄺ', 'ㄻ', 'ㄼ', 'ㄽ', 'ㄾ', 'ㄿ', 'ㅀ', 'ㅁ', 'ㅄ', 'ㅅ', 'ㅆ', 'ㅇ', 'ㅈ',
            'ㅊ', 'ㅋ', 'ㅌ', 'ㅍ', 'ㅎ']
# 한글 유니코드 다 적어야 하나??
hangul = []
        ...
        while True:
            ...
            if keyboard.read_key() == Button_input:
                ...
                if input_mode == 1:
                    ...
                    num_input = switch_button_input.push_Button_input_num(num_input,
                                                                          count_updown)  # num_input이 처음엔 빈 공백으로 있으면 어떻게 되는가???
                    # num_input 읽어주기
                ...
                print('sung_index_1,sung_index_2,sung_index_3,sung_index_4', sung_index_1, sung_index_2, sung_index_3,
                      sung_index_4)
                count_updown = 0
